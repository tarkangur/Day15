...
def count_down(count):
    ...
    if count > 0:
        ...
        for _ in range(work_sessions):
            marks += "✔"
        check_label.config(text=marks, fg=GREEN, bg=YELLOW, font=(FONT_NAME, 15, "bold"))
# ---------------------------- UI SETUP ------------------------------- #
...
reset_button = tkinter.Button(text="Reset", highlightthickness=0, command=restart_timer)
